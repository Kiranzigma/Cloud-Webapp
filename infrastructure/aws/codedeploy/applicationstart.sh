...
echo "sudo touch setenv.sh" >> /tmp/tempFile.sh
echo "sudo chmod 777 setenv.sh" >> /tmp/tempFile.sh 
echo "sudo echo 'export spring.profiles.active=cloud' >> setenv.sh" >> /tmp/tempFile.sh
...
echo "./startup.sh" >> /tmp/tempFile.sh
cd /tmp/
