...
public class BookController {
	...
	@PostMapping("/bookkiran/{id}/image")
	@ResponseBody
	...
	@GetMapping("/bookkiran/{idBook}/image/{idImage}")
	@ResponseBody
	...
	@PutMapping("/bookkiran/{idBook}/image/{idImage}")
	...
	@DeleteMapping("/bookkiran/{idBook}/image/{idImage}")
